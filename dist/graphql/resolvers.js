...
exports.resolvers = {
    Query: {
        ...
        getProductById: (_1, _a) => __awaiter(void 0, [_1, _a], void 0, function* (_, { productId }) { yield product_controller_1.default.getProductById(productId); }),
        getCustomerById: (_1, _a) => __awaiter(void 0, [_1, _a], void 0, function* (_, { customerId }) { yield customer_controller_1.default.getCustomerById(customerId); }),
    },
    Product: {
        customers: (parent) => __awaiter(void 0, void 0, void 0, function* () {
            yield customer_controller_1.default.getCustomerById;
        })
    },
    Customer: {
        products: (parent) => __awaiter(void 0, void 0, void 0, function* () {
            yield product_controller_1.default.getProductById;
        })
    },
    Order: {
